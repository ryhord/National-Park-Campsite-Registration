...
namespace Capstone.Tests
{
	...
	public class ReservationDAL_Tests : CampgroundDBTests
	{
		...
		[TestMethod]
		public void CreateReservation_Fail_Test()
		{
			Reservation res = new Reservation();
			res.SiteId = 6;
			res.Name = "Ryan";
			res.FromDate = Convert.ToDateTime("2018-06-20");
			res.ToDate = Convert.ToDateTime("2018-06-25");
			...
			Assert.AreEqual(initialNumberOfReservations, finalNumberOfReservations);
		}
